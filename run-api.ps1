...
Write-Host "Starting RestaurantRoller.API in $Environment environment..." -ForegroundColor Cyan
...
# Start the API as a background job with the specified environment
